...
<head>
    ...
    <title>Employee Profile - Delacruz Vanryan M</title>
    <style>
        body {
            background: linear-gradient(to bottom, #1E2839, #ff9d00);
            color: #ffffff;
...
<body>
    <div class="container">
        <div class="pic">
            <img src="34.jpg" alt="Profile Picture">
        </div>
        <div class="text">
